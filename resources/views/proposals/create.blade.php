                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('proposals.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="terms_conditions" name="terms_conditions" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="6">{{ old('terms_conditions') }}</textarea>
