    ...
    <div class="space-y-6">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <p class="mt-1 text-gray-600">Here's what's happening with your CRM today.</p>
            </div>
        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-semibold text-gray-900">{{ \App\Models\Proposal::where('status', 'active')->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-semibold text-gray-900">{{ \App\Models\Invoice::whereIn('status', ['draft', 'sent'])->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-semibold text-gray-900">${{ number_format(\App\Models\Invoice::where('status', 'paid')->sum('total_amount'), 2) }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex-shrink-0">
                                    <span class="inline-flex items-center justify-center h-8 w-8 rounded-full bg-indigo-100">
                                        <span class="text-sm font-medium leading-none text-indigo-600">{{ substr($activity->user->name, 0, 1) }}</span>
                                    </span>
                                </div>
